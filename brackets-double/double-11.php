...
?>
	...
	<!-- <h1 id="headline">Basketball</h1> -->
	 ...
	 <?php
        ...
        $query7 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 3</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 2</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=7 ORDER BY a.match_id ASC") or die(mysql_error());
        $row7 = mysql_fetch_array($query7);
        $query8 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 4</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 2</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=8 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query10 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 7</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 1</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=10 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query12 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 6</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=12 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query15 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 13</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=15 ORDER BY a.match_id ASC") or die(mysql_error());
        $row15 = mysql_fetch_array($query15);
        $query16 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 14</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=16 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query19 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 18</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=19 ORDER BY a.match_id ASC") or die(mysql_error());
