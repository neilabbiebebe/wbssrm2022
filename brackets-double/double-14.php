...
?>
	...
	<!-- <h1 id="headline">Basketball</h1> -->
	 ...
	 <?php
        ...
        $query18 = mysql_query("SELECT a.*,b.team_acro AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=18 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query21 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 19</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=21 ORDER BY a.match_id ASC") or die(mysql_error());
        $row21 = mysql_fetch_array($query21);
        $query22 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 20</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=22 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query25 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 24</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=25 ORDER BY a.match_id ASC") or die(mysql_error());
