...
?>
	...
	<!-- <h1 id="headline">Basketball</h1> -->
	 ...
	 <?php
        ...
        $query8 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 2</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 3</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=8 ORDER BY a.match_id ASC") or die(mysql_error());
        $row8 = mysql_fetch_array($query8);
        $query9 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 4</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 5</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=9 ORDER BY a.match_id ASC") or die(mysql_error());
        $row9 = mysql_fetch_array($query9);
        $query10 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 6</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,IF(ISNULL(c.team_acro),'<i>Loser of 7</i>',c.team_acro) AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=10 ORDER BY a.match_id ASC") or die(mysql_error());
        ...
        $query15 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 11</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=15 ORDER BY a.match_id ASC") or die(mysql_error());
        $row15 = mysql_fetch_array($query15);
        $query16 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 12</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=16 ORDER BY a.match_id ASC") or die(mysql_error());
		...
		$query23 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 21</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=23 ORDER BY a.match_id ASC") or die(mysql_error());
        $row23 = mysql_fetch_array($query23);
		$query24 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 22</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=24 ORDER BY a.match_id ASC") or die(mysql_error());
        $row24 = mysql_fetch_array($query24);
        $query25 = mysql_query("SELECT a.*,b.team_acro AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=25 ORDER BY a.match_id ASC") or die(mysql_error());
        $row25 = mysql_fetch_array($query25);
		$query26 = mysql_query("SELECT a.*,b.team_acro AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=26 ORDER BY a.match_id ASC") or die(mysql_error());
        $row26 = mysql_fetch_array($query26);
        $query27 = mysql_query("SELECT a.*,IF(ISNULL(b.team_acro),'<i>Loser of 26</i>',b.team_acro) AS team_1,IF(b.logo='','nologo.png',b.logo) AS logo_1,c.team_acro AS team_2,IF(c.logo='','nologo.png',c.logo) AS logo_2 FROM tournament_match a LEFT JOIN team b ON a.team_id_1=b.team_id LEFT JOIN team c ON a.team_id_2=c.team_id WHERE a.tour_sports_id=".$tour_sports_id." AND a.tournament_id=".$tour_id." AND a.bracket_no=27 ORDER BY a.match_id ASC") or die(mysql_error());
