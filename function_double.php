        ...
        elseif($_POST['count']==7){
            ...
            foreach($data as $t){
                ...
                elseif($count==7){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",".$team7.",'',0,'',5)";
                    mysql_query($query3,$conn) or die(mysql_error());
        ...
        elseif($_POST['count']==9){
            ...
            foreach($data as $t){
                ...
                elseif($count==9){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',16)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==10){
            ...
            foreach($data as $t){
                ...
                elseif($count==10){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',17)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',18)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==11){
            ...
            foreach($data as $t){
                ...
                elseif($count==11){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',19)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',20)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==12){
            ...
            foreach($data as $t){
                ...
                elseif($count==12){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',21)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',22)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==13){
            ...
            foreach($data as $t){
                ...
                elseif($count==12){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",".$team12.",'',0,'',9)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                elseif($count==13){
                    $team13 = $t;

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",".$team13.",'',0,'',10)";
                    mysql_query($query3,$conn) or die(mysql_error());
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',23)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',24)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==14){
            ...
            foreach($data as $t){
                ...
                elseif($count==14){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",".$team14.",'',0,'',11)";
                    mysql_query($query3,$conn) or die(mysql_error());
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',25)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',26)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==15){
            ...
            foreach($data as $t){
                ...
                elseif($count==15){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",".$team15.",'',0,'',11)";
                    mysql_query($query3,$conn) or die(mysql_error());
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',27)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',28)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
        ...
        elseif($_POST['count']==16){
            ...
            foreach($data as $t){
                ...
                elseif($count==16){
                    ...
                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',29)";
                    mysql_query($query3,$conn) or die(mysql_error());

                    $query3 = "INSERT INTO tournament_match VALUES(null,".$_POST['tid'].",".$result['last_id'].",0,'',0,'',30)";
                    mysql_query($query3,$conn) or die(mysql_error());
                }
                $count++;
            }
